...
import { BentoGrid, BentoGridItem } from "@/app/_components/ui/BentoGrid";
import {
...
const SkeletonFour = () => {
    ...
    return (
        ...
        <motion.div
            variants={second}
            className="h-full w-1/3 rounded-2xl p-4 bg-black border-white/[0.1] flex flex-col items-center justify-center"
        >
            <Image
            src="/assets/himanshu.jpg"
            alt="avatar"
            height="100"
            width="100"
            className="rounded-full h-10 w-10"
