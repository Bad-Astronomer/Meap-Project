  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_FLASK_URL}/upload`,
        formData,
        {
          headers: {
    ...
    <div className="w-auto flex items-center justify-center gap-4 m-20">
              ...
              <div className="absolute inset-0 flex items-center justify-center z-20">
                ...
                <div className="bg-black opacity-[0.5] h-full w-full flex items-center">
                  ...
                  <Image
                    ...
                    layout="fill"
                    objectFit="contain"
                    className="opacity-50 mx-auto" // Added mx-auto for horizontal centering
                  />
                </div>
              </div>
            ) : (
      ...
      <div className="h-96 w-1/6 block border border-neutral-700 rounded-xl flex flex-col backdrop-blur-[3px]">
        <div className="relative basis-5/6 w-auto m-4 rounded-xl bg-neutral-900 text-white">
          ...
          />
          <button
            className="absolute gemini-button"
            onClick={handleEnhancePrompt}
          >
            <Image // Replace with your logo filename
