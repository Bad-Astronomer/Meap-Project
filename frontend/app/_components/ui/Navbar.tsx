    ...
    return (
      ...
      <Link
        ...
        className={cn(
          ...
          "border border-transparent text-sm font-medium relative text-white px-4 mx-4 py-2 rounded-full hover:border hover:border-neutral-500 transition-colors duration-200 bg-neutral-800"
        )}
        onClick={() => signOut()}
      >
        <span>Logout</span>
